...
Value wyrm_fn_can_gen_double(Value wyrm_var_node) {
    ...
    if (val_to_bool(val_ne(val_type(wyrm_var_node), val_string("Array")))) {
    return val_bool(false);
    }
    ...
    return val_eq(wyrm_fn_get_var_type(val_array_get(wyrm_var_node, val_number(1))), val_string("Number"));
    }
    if (val_to_bool(val_eq(wyrm_var_n_type, val_string("BinaryOp")))) {
    Value wyrm_var_op = val_array_get(wyrm_var_node, val_number(1));
    if (val_to_bool(val_or(val_or(val_or(val_eq(wyrm_var_op, val_string("+")), val_eq(wyrm_var_op, val_string("-"))), val_eq(wyrm_var_op, val_string("*"))), val_eq(wyrm_var_op, val_string("/"))))) {
    return val_and(wyrm_fn_can_gen_double(val_array_get(wyrm_var_node, val_number(2))), wyrm_fn_can_gen_double(val_array_get(wyrm_var_node, val_number(3))));
    }
    }
    if (val_to_bool(val_eq(wyrm_var_n_type, val_string("UnaryOp")))) {
    Value wyrm_var_op = val_array_get(wyrm_var_node, val_number(1));
    if (val_to_bool(val_eq(wyrm_var_op, val_string("-")))) {
    return wyrm_fn_can_gen_double(val_array_get(wyrm_var_node, val_number(2)));
    }
    }
    return val_bool(false);
    return val_null();
...
Value wyrm_fn_gen_double_expr(Value wyrm_var_node) {
    ...
    wyrm_fn_emit_inst(val_add(val_add(val_add(wyrm_var_dbl_val, val_string(" = load double, ptr @wyrm_var_")), wyrm_var_name), val_string(", align 8")));
    }
    else {
    wyrm_fn_emit_inst(val_add(val_add(val_add(wyrm_var_dbl_val, val_string(" = load double, ptr %wyrm_var_")), wyrm_var_name), val_string(", align 8")));
    }
    return wyrm_var_dbl_val;
    }
    if (val_to_bool(val_eq(wyrm_var_n_type, val_string("BinaryOp")))) {
    Value wyrm_var_op = val_array_get(wyrm_var_node, val_number(1));
    Value wyrm_var_left = wyrm_fn_gen_double_expr(val_array_get(wyrm_var_node, val_number(2)));
    Value wyrm_var_right = wyrm_fn_gen_double_expr(val_array_get(wyrm_var_node, val_number(3)));
    Value wyrm_var_res = val_add(val_string("%dbl_op_"), val_str(val_array_get(wyrm_var_temp_count, val_number(0))));
    val_array_set(wyrm_var_temp_count, val_number(0), val_add(val_array_get(wyrm_var_temp_count, val_number(0)), val_number(1)));
    Value wyrm_var_instr = val_string("fadd");
    if (val_to_bool(val_eq(wyrm_var_op, val_string("-")))) {
    wyrm_var_instr = val_string("fsub");
    }
    else if (val_to_bool(val_eq(wyrm_var_op, val_string("*")))) {
    wyrm_var_instr = val_string("fmul");
    }
    else if (val_to_bool(val_eq(wyrm_var_op, val_string("/")))) {
    wyrm_var_instr = val_string("fdiv");
    }
    wyrm_fn_emit_inst(val_add(val_add(val_add(val_add(val_add(val_add(wyrm_var_res, val_string(" = ")), wyrm_var_instr), val_string(" double ")), wyrm_var_left), val_string(", ")), wyrm_var_right));
    return wyrm_var_res;
    }
    if (val_to_bool(val_eq(wyrm_var_n_type, val_string("UnaryOp")))) {
    Value wyrm_var_op = val_array_get(wyrm_var_node, val_number(1));
    Value wyrm_var_sub = wyrm_fn_gen_double_expr(val_array_get(wyrm_var_node, val_number(2)));
    Value wyrm_var_res = val_add(val_string("%dbl_un_"), val_str(val_array_get(wyrm_var_temp_count, val_number(0))));
    val_array_set(wyrm_var_temp_count, val_number(0), val_add(val_array_get(wyrm_var_temp_count, val_number(0)), val_number(1)));
    wyrm_fn_emit_inst(val_add(val_add(wyrm_var_res, val_string(" = fneg double ")), wyrm_var_sub));
    return wyrm_var_res;
    }
    return val_string("0.0");
    return val_null();
...
Value wyrm_fn_infer_expr_type_in_scope(Value wyrm_var_expr) {
    ...
    if (val_to_bool(val_or(val_or(val_or(val_eq(wyrm_var_op, val_string("+")), val_eq(wyrm_var_op, val_string("-"))), val_eq(wyrm_var_op, val_string("*"))), val_eq(wyrm_var_op, val_string("/"))))) {
    Value wyrm_var_left_t = wyrm_fn_infer_expr_type_in_scope(val_array_get(wyrm_var_expr, val_number(2)));
    Value wyrm_var_right_t = wyrm_fn_infer_expr_type_in_scope(val_array_get(wyrm_var_expr, val_number(3)));
    if (val_to_bool(val_and(val_eq(wyrm_var_left_t, val_string("Number")), val_eq(wyrm_var_right_t, val_string("Number"))))) {
    return val_string("Number");
    }
    }
    return val_string("Dynamic");
    ...
    if (val_to_bool(val_eq(wyrm_var_sub_t, val_string("Number")))) {
    return val_string("Number");
    }
    }
    return val_string("Dynamic");
...
Value wyrm_fn_scan_stmt_types(Value wyrm_var_stmt) {
    ...
    if (val_to_bool(val_and(val_eq(wyrm_var_current_type, val_string("Number")), val_ne(wyrm_var_val_type, val_string("Number"))))) {
...
Value wyrm_fn_analyze_scope_types(Value wyrm_var_body, Value wyrm_var_params) {
    Value wyrm_var_current_local_types = val_array_init(0);
    Value wyrm_var_i = val_number(0);
...
Value wyrm_fn_gen_expr(Value wyrm_var_node) {
    ...
    Value wyrm_var_name = val_array_get(wyrm_var_node, val_number(1));
    Value wyrm_var_v_type = wyrm_fn_get_var_type(wyrm_var_name);
    if (val_to_bool(val_eq(wyrm_var_v_type, val_string("Number")))) {
    Value wyrm_var_t = wyrm_fn_gen_temp();
    Value wyrm_var_dbl_val = val_add(val_string("%dbl_val_"), val_str(val_array_get(wyrm_var_temp_count, val_number(0))));
    val_array_set(wyrm_var_temp_count, val_number(0), val_add(val_array_get(wyrm_var_temp_count, val_number(0)), val_number(1)));
    if (val_to_bool(wyrm_fn_contains_val(val_array_get(wyrm_var_declared_globals, val_number(0)), wyrm_var_name))) {
    ...
    wyrm_fn_emit_inst(val_add(val_add(val_add(val_add(val_string("call void @llvm_val_number(ptr "), wyrm_var_t), val_string(", double ")), wyrm_var_dbl_val), val_string(")")));
    return wyrm_var_t;
    }
    if (val_to_bool(wyrm_fn_contains_val(val_array_get(wyrm_var_declared_globals, val_number(0)), wyrm_var_name))) {
    ...
    Value wyrm_var_op = val_array_get(wyrm_var_node, val_number(1));
    if (val_to_bool(val_or(val_or(val_or(val_eq(wyrm_var_op, val_string("+")), val_eq(wyrm_var_op, val_string("-"))), val_eq(wyrm_var_op, val_string("*"))), val_eq(wyrm_var_op, val_string("/"))))) {
    if (val_to_bool(wyrm_fn_can_gen_double(wyrm_var_node))) {
...
Value wyrm_fn_gen_statement(Value wyrm_var_stmt) {
    ...
    Value wyrm_var_current_local_types = wyrm_var_outer_types;
    return val_null();
    }
    ...
    val_array_append(val_array_get(wyrm_var_g_allocas, val_number(0)), val_add(val_add(val_string("  %wyrm_var_"), wyrm_var_name), val_string(" = alloca double, align 8")));
    val_array_append(val_array_get(wyrm_var_declared_locals, val_number(0)), wyrm_var_name);
    }
    if (val_to_bool(wyrm_fn_can_gen_double(wyrm_var_val))) {
    Value wyrm_var_val_reg = wyrm_fn_gen_double_expr(wyrm_var_val);
    wyrm_fn_emit_inst(val_add(val_add(val_add(val_add(val_string("store double "), wyrm_var_val_reg), val_string(", ptr %wyrm_var_")), wyrm_var_name), val_string(", align 8")));
    }
    else {
    ...
    wyrm_fn_emit_inst(val_add(val_add(val_add(val_add(val_string("store double "), wyrm_var_dbl_val), val_string(", ptr %wyrm_var_")), wyrm_var_name), val_string(", align 8")));
    }
    }
    else {
    val_array_append(wyrm_var_g_llvm_globals, val_add(val_add(val_string("@wyrm_var_"), wyrm_var_name), val_string(" = global double 0.0, align 8")));
    if (val_to_bool(wyrm_fn_can_gen_double(wyrm_var_val))) {
    Value wyrm_var_val_reg = wyrm_fn_gen_double_expr(wyrm_var_val);
    wyrm_fn_emit_inst(val_add(val_add(val_add(val_add(val_string("store double "), wyrm_var_val_reg), val_string(", ptr @wyrm_var_")), wyrm_var_name), val_string(", align 8")));
    }
    ...
    Value wyrm_var_dummy = val_add(val_string("unreachable_"), val_str(val_array_get(wyrm_var_temp_count, val_number(0))));
    val_array_set(wyrm_var_temp_count, val_number(0), val_add(val_array_get(wyrm_var_temp_count, val_number(0)), val_number(1)));
    wyrm_fn_emit_label(val_add(wyrm_var_dummy, val_string(":")));
    return val_null();
    }
...
Value wyrm_fn_transpile_llvm(Value wyrm_var_ast) {
    val_array_append(wyrm_var_g_llvm_globals, val_string("; Module generated by Wyrm 2.4.1 LLVM backend"));
...
Value wyrm_fn_main() {
    ...
    val_print(1, val_string("Wyrm Compiler & LLVM IR Generator (wyrmc) v2.4.1"));
    ...
    val_print(1, val_add(val_add(val_add(val_add(val_string("[wyrmc Compiler v2.4.1] Successfully compiled '"), wyrm_var_source_file), val_string("' -> Native Binary '")), wyrm_var_out_exe), val_string("' (via LLVM IR)")));
    return val_null();
}
